...
**导航**：[书籍主页](./index.html) | [完整目录](./TOC.html) | [上一章](./chapter2.html) | 下一章：第4章（即将发布）
...
**与全书的关系**：第1章给出分层与 CQRS 骨架；本章给出**同层内的代码组织手法**；第4章将从评审与质量门禁角度防止回潮；第9章、第14章将在营销与订单领域放大这些模式。

---

**导航**：[返回目录](./TOC.html) | [上一章](./chapter2.html) | [书籍主页](./index.html) | 下一章：第4章（即将发布）
