...
本文是电商系统设计系列的第六篇，是[（五）计价引擎](/system-design/24-ecommerce-pricing-engine/)的姊妹篇，从 DDD 视角重新审视计价系统的建模。

> 本文是计价引擎系列的方法论篇，聚焦 DDD 在计价系统中的战略/战术设计实践。系统架构与实现细节详见：[电商系统设计（五）：计价引擎](/system-design/24-ecommerce-pricing-engine/)。
...
> **系列导航**
> 计价引擎的工程实现细节（多级缓存、降级策略等），详见[（五）计价引擎](/system-design/24-ecommerce-pricing-engine/)。
