...
> **电商系统设计系列**（与{% post_link system-design/20-ecommerce-overview （一）推荐阅读顺序 %}一致）
...
本文是电商系统设计系列的第六篇，是{% post_link system-design/24-ecommerce-pricing-engine （五）计价引擎 %}的姊妹篇，从 DDD 视角重新审视计价系统的建模。

> 本文是计价引擎系列的方法论篇，聚焦 DDD 在计价系统中的战略/战术设计实践。系统架构与实现细节详见：{% post_link system-design/24-ecommerce-pricing-engine 电商系统设计（五）：计价引擎 %}。
...
### 相关文章
1. {% post_link system-design/24-ecommerce-pricing-engine 电商系统价格计算引擎设计与实现 %} — 系统架构、场景分析、核心实现
...
> **系列导航**
> 计价引擎的工程实现细节（多级缓存、降级策略等），详见{% post_link system-design/24-ecommerce-pricing-engine （五）计价引擎 %}。
