...
**核心考点速查**:
- [SRE 层次结构](#前言怎样的系统算是稳定高可用的) - Dickerson 层级模型
- [监控与告警](#监控与告警) - 监控指标体系、告警策略
- [高可用架构](#高可用架构设计) - 多活部署、异地容灾
- [保护性机制](#保护性机制) - 熔断/降级/限流/重试
- [容量规划](#容量规划与压测) - 容量评估、压测方案
- [SLI/SLO/SLA](#sre-核心指标体系) - 服务等级定义
- [故障应急](#故障应急响应) - 故障等级、应急流程
