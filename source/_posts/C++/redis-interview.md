...
3. redis 超过使用容量时的内存淘汰策略
4. redis 过期键的删除策略
5. 如何处理可能遇到的缓存雪崩，缓存穿透和热点数据缓存击穿问题？是否需要缓存预热
6. 缓存和数据库一致性的问题？
7. 
8. 缓存持久化策略
9. 如何做的缓存初始，缓存预热？

10. 了解单机redis、读写主从redis模式、哨兵模式的redis、redis分布式集群
11. redis 分布式锁？
12. 在使用redis缓存mysql数据架构时，**缓存更新的策略？**业务测怎么更新，怎么使用组件更新？
...
4. **codis**: https://github.com/CodisLabs/codis
...
7. [redis 分布式架构演进](https://blog.csdn.net/QQ1006207580/article/details/103243281)
