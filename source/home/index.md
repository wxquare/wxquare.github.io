...
- [LeetCode Primer](https://github.com/wxquare/leetcode-primer)：持续整理算法题、解题思路与面试基础。
- [AI Agent 工程实践](/ai-book/)：从大模型基础到生产级智能体系统。
...
- [Karpathy 的自我进化知识库：LLM 时代的知识管理范式](/2026/04/05/AI/02-karpathy-evolving-knowledge-base/)
