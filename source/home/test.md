...
layout: page
permalink: /
description: 专注 AI、Agent 系统设计、后端架构与工程实践的技术博客与项目汇总。
keywords: AI Agent, 系统设计, 架构实践, C++, LeetCode, 后端工程
toc:
  enable: false
---

# 💡 专注 AI Agent、系统设计与工程实践

这里是我持续维护的技术专栏、开源项目与代表文章汇集地。

[GitHub](https://github.com/wxquare) · [RSS 订阅](/atom.xml) · [所有文章归档](/archives/)
...
- 📘 **[AI Agent 工程实践](/ai-book/)**  
  *专栏/电子书* · 从大模型基础到生产级智能体系统的全栈架构指南。
- 🏗️ **[System Design Primer](/system-design-primer/)**  
  *知识库* · 互联网系统与系统设计面试的高频考点与架构演进系统梳理。
- 💡 **[LeetCode Primer](https://github.com/wxquare/leetcode-primer)**  
  *开源仓库* · 持续整理算法题、解题思路与面试基础。
- 🛠️ **[本站源码](https://github.com/wxquare/wxquare.github.io)**  
  *开源仓库* · 博客、开源书籍与公开资料的底层维护仓库。
...
> 记录正在构思、实验或阶段性验证中的个人项目。

- ⚙️ **SkillForge** `[🚧 开发中]`：面向可复用 Agent Skills 的工具与工作流探索。
- 📈 **Investment Assistant** `[🔬 实验中]`：投资研究、信息整理与辅助决策实验。
- 🔐 **wxquare-private** `[🔒 私有]`：个人研究、实验与协作资产的私有工作区。
