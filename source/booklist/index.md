...
- [C++ Primer](https://www.informit.com/store/c-plus-plus-primer-9780321714114)（Stanley B. Lippman 等）— 系统掌握现代 C++ 的类型、资源管理和标准库。
- [Effective C++](https://www.informit.com/store/effective-c-plus-plus-55-specific-ways-to-improve-your-9780321334879)（Scott Meyers）— 用具体准则打磨资源管理、继承和接口设计。
- [The Linux Programming Interface](https://man7.org/tlpi/)（Michael Kerrisk）— 从进程、线程、文件系统到网络，建立 Unix 编程的心智模型。
- [Python Crash Course](https://nostarch.com/pythoncrashcourse3e)（Eric Matthes）— 通过小项目进入 Python、测试和部署。
...
- [AI Agent 工程实践](/ai-book/)（本站专题）— 从上下文工程到评估与可观测性，系统拆解生产级 Agent。

## 思维、商业与人文

- [Influence](https://www.harpercollins.com/products/influence-new-and-expanded-robert-b-cialdini)（Robert B. Cialdini）— 理解互惠、社会认同和稀缺等影响机制。
- [Zero to One](https://zerotoonebook.com/)（Peter Thiel、Blake Masters）— 用长期思考与差异化视角反思产品和创业。
