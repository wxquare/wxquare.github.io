...
**与全书脉络的关系**：第 29 章计价给出「应付金额的合理解释」，第 36 章完成「购物车、结算与订单沉淀」，本章则把承诺兑现为**外部世界的扣款事实**；第 34 章会把支付放回 B2B2C 聚合场景，观察供应商履约与渠道结算如何共同挤压支付边界。
...
**子系统职责对照**：支付系统职责对照和答辩口径已统一收录到[附录 D 的相应核心案例](../appendix/system-design-questionbank.md#q-sd-core-08支付回调退款与对账)。
...
反模式清单已统一收录到[附录 D 的相应核心案例](../appendix/system-design-questionbank.md#q-sd-core-08支付回调退款与对账)。
