...
关于大事务、Saga 和 Outbox 的通用流程可参见[第 4 章《大事务处理方法论》](04-large-transaction-orchestration.md)；购物车、结算、订单和支付的完整领域实现可参见[第 36 章《电商用户 C 端搜索、交易、履约与售后全生命周期设计》](../part03/13-ecommerce-customer-lifecycle.md)。本章只保留跨场景的判断框架和关键取舍。
