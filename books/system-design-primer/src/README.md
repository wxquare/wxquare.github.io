...
2. **后端面试基础知识题单**：按 MySQL、Redis、Kafka、Elasticsearch、Docker、Kubernetes、操作系统、网络、Bash、Python、C++、Go 十二个小主题整理纯题单；全局 ID 与技术栈选型不纳入本题单。
...
| 章节 | 主题 | 内容速览 | 阅读收获 |
| --- | --- | --- | --- |
| [后端面试基础知识题单](part02/01-interview-basic-questions.md) | MySQL、Redis、Kafka、Elasticsearch、Docker、Kubernetes、操作系统、计算机网络、Bash、Python、C++、Go | 面向 3–10 年开发工程师，筛选 1,000 道高频、通用的存储、缓存、消息、搜索、容器、操作系统、网络、工程工具和编程语言题目，去除具体业务题。 | 按小主题复习高频后端基础知识。 |
