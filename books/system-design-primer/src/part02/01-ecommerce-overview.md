...
**答辩提示**：业务架构图的表述模板已统一收录到[第 39 章的“专题答辩资料：业务架构图表述模板”](../part03/03-ecommerce-questionbank.md#chapter39-business-architecture-template)。
...
|------|------|----------|------------|----------|
| 1 | 商品中心 | SPU/SKU、类目属性、商品快照与主数据质量 | 库存扣减、营销计算、支付 | [第 25 章](./03-product-center.md) |
...
| 10 | 商品上架 | 上架审核、发布流程、供给侧状态机 | 不复制商品中心全量模型职责 | [第 26 章](./02-product-supply-lifecycle-ops.md) |
| 11 | 供给与运营管理 | 批量任务、配置工具、权限与审计 | 不绕过商品中心直接写「影子库」 | [第 26 章](./02-product-supply-lifecycle-ops.md) |
| 12 | 生命周期与供给治理 | 同步/编辑/下架边界、跨系统编排约束 | 不实现全量搜索召回 | [第 26 章](./02-product-supply-lifecycle-ops.md) |
