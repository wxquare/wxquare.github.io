...
> **本章定位**：如果第 25 章回答的是“平台怎样把商品供给进来、治理好、发布出去”，这一章回答的就是“用户怎样从发现商品一路走到支付、履约、核销与售后”。它不是对搜索、购物车、订单、支付四章的简单拼接，而是站在 **C 端交易旅程** 视角，把弱一致读链路、强一致交易链路、履约后链路以及解释历史事实的快照体系收敛成一条完整主线。
