...
第 12 章分析了 AI Coding Agent，第 13 章分析了企业知识助手，第 14 章分析了 LangGraph、AutoGen、MCP 这类 Agent 平台与编排框架。本章继续分析一个更贴近个人生产力场景的成熟系统：OpenClaw。
...
这个流程可以和第 12 章的 Coding Agent Loop 对照：
...
这和第 12 章 Coding Agent 的权限模型一致：先从 read-only 开始，再逐步开放 write 和 exec。
...
如果第 12 章的 Coding Agent 代表“AI 如何参与软件工程”，OpenClaw 代表的则是另一个方向：**AI 如何成为长期在线、跨渠道、可扩展、可治理的个人助手基础设施。**
