...
前两部分已经建立了 LLM 能力边界、Prompt/Context/Harness 方法论，以及 Agent 架构、工具系统、知识系统和生产治理的设计框架。第 12-16 章进一步拆解了 Coding Agent、企业知识助手、Agent 平台、OpenClaw 和 Hermes Agent 这些成熟系统。现在是时候把这些原则放进一个完整的生产级案例中观察。
...
第18章我们将探讨另一个实战案例：个人知识管理 Agent，展示如何将 Agent 应用于个人生产力场景，包括知识整理、学习路径规划、文档自动化等。
