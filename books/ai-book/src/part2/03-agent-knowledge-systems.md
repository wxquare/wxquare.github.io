# 第13章 Agent 知识系统：从知识源、RAG 到 Agentic RAG
...
### 13.1.3 知识供给分层：Prompt、Context、Tool、RAG、Memory
...
### 13.1.4 Source Routing：先判断该去哪儿找知识
...
### 13.2.1 Markdown / Docs-as-Code：工程化知识沉淀
...
### 13.2.5 MCP Tool / 外部 API：实时结构化事实
...
### 13.2.7 GBrain 类系统：Agent 长期知识演化
...
### 13.3.4 Chunk 策略：检索单位、上下文单位、引用单位
...
### 13.3.7 Hybrid Search：关键词检索为什么仍然重要
...
### 13.4.1 Query Understanding：理解用户到底要查什么
...
### 13.4.2 Query Rewrite 与 Query Expansion
...
### 13.4.4 Candidate Retrieval：召回候选证据
...
### 13.4.7 Context Package：把检索结果变成证据包
...
## 13.5 Web Search 与实时外部知识

### 13.5.1 Web Search 的实现原理
...
### 13.5.2 Google API、Bing、Brave、SerpAPI、Tavily、Exa 的角色
...
### 13.5.6 股票分析案例：行情、新闻、财报、技术指标如何组合
...
## 13.6 MCP Resource、Tool 与 RAG 的组合

### 13.6.1 RAG 与 MCP Resource 的本质区别
...
### 13.6.4 RAG + MCP Resource：先检索，再读取完整资源
...
### 13.6.5 RAG + Tool：把工具结果纳入 Evidence
...
### 13.6.6 Tool-Augmented Retrieval 的优先级与风险
...
### 13.7.7 Decide Next Step：继续检索、换源、验证或停止
...
### 13.7.8 Synthesize + Verify：综合与验证
...
### 13.8.1 Query Decomposition 的风险
...
### 13.8.2 Multi-hop Retrieval：跨证据链路检索
...
### 13.8.3 Bridge Entity：通过中间实体继续追踪
...
### 13.8.6 反证检索与 Self-Verification
...
### 13.9.3 Citation 与 Claim-level Citation
...
### 13.9.4 Evidence Sufficiency Check
