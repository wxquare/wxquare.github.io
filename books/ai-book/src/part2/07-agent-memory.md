# 第11章 Agent 状态管理：Memory、会话与长期上下文
...
## 11.3 Memory Control Plane：记忆控制面
...
AGENT_READ_FILE(books/ai-book/src/part2/07-agent-memory.md)
