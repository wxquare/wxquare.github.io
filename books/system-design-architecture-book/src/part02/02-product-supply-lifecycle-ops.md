...
批量导入链路中的 `task` 与 `task_item` 状态机，建议统一收敛到 [26.3 商品生命周期管理](#/part02/05-product-supply-ops.html?highlight=26.3) 中维护，避免在执行链路章节重复定义后逐渐漂移。
...
具体状态定义、状态说明和聚合规则，见 `26.3.2.5 Task 状态机` 与 `26.3.2.6 Task Item 状态机`。
...
本章相关总结、常见问题和参考要点已统一收录到[第 39 章的“商品供给与运营治理”题卡](../part03/03-ecommerce-questionbank.md#q-ecom-supply-054为什么商品供给与运营平台不能设计成商品中心的后台-crud)。
...
核心判断已统一收录到[第 39 章的“商品供给与运营治理”题卡](../part03/03-ecommerce-questionbank.md#q-ecom-supply-054为什么商品供给与运营平台不能设计成商品中心的后台-crud)。
...
本专题相关总结、常见问题和参考回答已统一收录到[第 39 章的“供应商同步与人工上传”题卡](../part03/03-ecommerce-questionbank.md#q-ecom-supply-056供应商同步和人工上传要分成两套系统吗)。
...
相关答辩提示已统一收录到[第 39 章的“供应商任务互斥”题卡](../part03/03-ecommerce-questionbank.md#q-ecom-supply-084上一次任务还没跑完又下发了一次任务怎么办)。
...
本专题相关总结、常见问题和参考回答已统一收录到[第 39 章的“供应商同步恢复与 DLQ”题卡](../part03/03-ecommerce-questionbank.md#q-ecom-supply-072供应商同步为什么需要-raw-snapshotcheckpoint-和-dlq)。
