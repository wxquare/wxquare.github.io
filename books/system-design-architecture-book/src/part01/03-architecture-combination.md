...
### 3.3.3 Clean Architecture：约束依赖方向
...
它们不再主要解决“单个系统内部怎么组织”，而是解决“多个系统之间如何可靠协作”。这也是为什么它们会放到第 6 章集中讨论。

### 3.3.6 编码原则与质量保障：守住架构落地质量
...
- **第 4 章《业务边界与战略设计》**：先讨论系统应该如何划清边界
- **第 5 章《系统内部结构设计》**：讨论单个系统内部如何建立秩序
- **第 6 章《系统集成与一致性设计》**：讨论多个系统之间如何协作
- **第 7 章《架构质量保障》**：讨论如何用评审和验证机制守住架构质量
- **第 8 章《编码原则与设计模式》**：讨论架构如何真正落到代码
