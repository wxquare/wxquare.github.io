...
### 10.7.4 Kafka DLQ 与 MySQL DLQ 的边界
...
第 5 章已经系统讨论监控体系，本章只列对账、补偿和 DLQ 必须具备的专项指标。
