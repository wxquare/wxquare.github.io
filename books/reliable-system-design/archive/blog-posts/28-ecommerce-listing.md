...
本文是电商系统设计系列的第九篇（运营管理层），建议先阅读[（一）全景概览与领域划分](/books/reliable-system-design/part03/01-ecommerce-overview.html)与[（二）商品中心系统](/books/reliable-system-design/part03/02-product-center.html)了解商品主数据与领域边界。
...
> **系列导航**
> 上架完成后，商品的库存管理详见[（三）库存系统](/books/reliable-system-design/part03/04-inventory-system.html)，价格配置详见[（五）计价引擎](/books/reliable-system-design/part03/06-pricing-system.html)。
