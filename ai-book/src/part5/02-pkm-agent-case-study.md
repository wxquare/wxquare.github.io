...
第8章我们看到了企业级 Agent 系统的复杂性。但 Agent 不仅适用于企业，也适用于个人生产力场景。
...
第10章我们将回归基础，深入探讨 **LLM 的能力边界与工程化要点**，帮你理解 Agent 系统的底层基础，包括 LLM 的能力边界、幻觉问题、Prompt Engineering、模型选择等。
