# 第12章 Agentic RAG 与高级检索模式：从单次问答到复杂知识任务
...
## 12.3 Query Planning：把问题拆成可检索任务
...
## 12.4 Multi-hop Retrieval：跨证据链路检索
...
## 12.6 Tool-Augmented Retrieval：检索不只来自文档
...
## 12.7 Self-Verification：让 Agent 证明答案有依据
