...
前面三部分我们深入学习了 AI 编程、Agent 系统设计和完整的实战案例。但要真正驾驭 Agent 系统，我们必须回归基础，深入理解 LLM 的**能力边界**和**工程化要点**。
...
第11章我们将深入探讨 **RAG 与上下文工程基础**，学习如何通过外部知识增强 LLM 的能力，包括向量数据库、Embedding 选择、检索策略、上下文构建等核心技术。
